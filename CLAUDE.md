...
ChatLens is a small paid tool that parses WhatsApp and Telegram chat exports to surface key info—addresses, schedules, images, documents—as a searchable, AI-summarized digest linked back to the original message.
